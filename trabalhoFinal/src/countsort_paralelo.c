...
void countsort_parallel(int *v, long int n, int num_threads) {
    ...
    // encontrar mínimo e máximo (pode ser feito em paralelo também)
    ...
    #pragma omp parallel num_threads(num_threads)
    {
        ...
        // região crítica: soma dos histogramas locais no global
        #pragma omp critical
        {
    ...
    // prefixo serial para reconstruir o vetor ordenado
    long int idx = 0;
